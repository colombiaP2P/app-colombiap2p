// ═══════════════════════════════════════════════════════════════
// ColombiaP2P — Sistema de Misiones (Merit Bounties)
// ═══════════════════════════════════════════════════════════════
...
const LBW_Missions = (function () {
            ...
            card.innerHTML = `
                ...
                <div style="padding:1rem;">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:0.75rem;">
                        <span style="font-weight:800;color:var(--color-gold);font-size:1rem;">⭐ ${m.merit_amount} méritos</span>
            ...
            <div class="modal-content" style="max-width:600px;padding:2rem;position:relative;">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.75rem;margin-bottom:1.5rem;">
                    <div style="padding:0.75rem;background:rgba(229,185,92,0.08);border-radius:10px;border:1px solid rgba(229,185,92,0.2);">
                        ...
                        <div style="font-size:1.2rem;font-weight:800;color:var(--color-gold);">⭐ ${m.merit_amount} méritos</div>
            ...
            <div class="modal-content" style="max-width:520px;padding:2rem;">
                ...
                <div id="missionSharePreview" style="background:linear-gradient(135deg,#0d1f2d 0%,#0a1520 100%);border:2px solid rgba(229,185,92,0.4);border-radius:16px;padding:1.5rem;margin-bottom:1.25rem;">
                    ...
                    <div style="display:flex;gap:0.5rem;flex-wrap:wrap;">
                        <span style="font-size:0.75rem;background:rgba(229,185,92,0.15);color:#E5B95C;padding:0.3rem 0.75rem;border-radius:20px;border:1px solid rgba(229,185,92,0.3);font-weight:700;">⭐ ${m.merit_amount} méritos</span>
                        ...
                        <span style="font-size:0.75rem;background:rgba(255,255,255,0.07);color:rgba(255,255,255,0.5);padding:0.3rem 0.75rem;border-radius:20px;">colombiap2p.com</span>
                    </div>
                </div>
    ...
    function _shareTelegram(missionId) {
        ...
        const url = `https://t.me/share/url?url=${encodeURIComponent('https://colombiap2p.com')}&text=${encodeURIComponent(text)}`;
        window.open(url, '_blank');
    }
    ...
    function showCreateForm() {
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width:640px;padding:2rem;max-height:90vh;overflow-y:auto;">
                ...
                <p style="font-size:0.82rem;color:var(--color-text-secondary);margin-bottom:1.5rem;">Publica una tarea que necesita la comunidad a cambio de méritos ColombiaP2P.</p>
